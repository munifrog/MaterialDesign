...
/**
 * A simple {@link RecyclerView} subclass that has a maxWidth
 */
public class MaxWidthRecyclerView extends RecyclerView {
    ...
    private int mMaxWidth = LayoutParams.MATCH_PARENT;
    ...
    public MaxWidthRecyclerView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        mMaxWidth = a.getLayoutDimension(0, LayoutParams.MATCH_PARENT);
        a.recycle();
    }
